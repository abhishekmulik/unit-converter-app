 ...
 */
function ResultDisplay({ value, unit, className }: ResultDisplayProps) {
      ...
      <div className="flex items-baseline gap-2">
        {hasResult ? (
          <>
            ...
            <span className="text-lg text-muted-foreground">{unit.symbol}</span>
          </>
        ) : (
          <span className="text-2xl font-mono text-muted-foreground/50">—</span>
        )}
      </div>
    </div>
  );
